            ...
            <div class="border-b dark:border-gray-800">
                ...
                >
                    ...
                    >
                        ...
                        <div
                            v-else
                            class="relative h-[65px] max-h-[65px] w-full max-w-[65px] overflow-hidden rounded-lg border border-dashed border-gray-300 dark:border-gray-800 dark:mix-blend-exclusion dark:invert"
                        >
