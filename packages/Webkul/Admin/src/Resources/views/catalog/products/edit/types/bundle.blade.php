...
@pushOnce('scripts')
    ...
    >
        <div class="box-shadow relative rounded-lg bg-white dark:bg-gray-900">
            <!-- Panel Header -->
            ...
            >
                ...
                <img
                    ...
                    class="h-20 w-20 rounded-lg border border-dashed dark:border-gray-800 dark:mix-blend-exclusion dark:invert"
                />
                        ...
                        <div class="flex justify-between gap-2.5 border-b border-slate-300 p-4 dark:border-gray-800">
                            ...
                            <div class="flex gap-2.5">
                                ...
                                <div
                                    ...
                                    :class="{'overflow-hidden rounded-lg border border-dashed border-gray-300 dark:border-gray-800 dark:mix-blend-exclusion dark:invert': ! element.product.images.length}"
                                >
