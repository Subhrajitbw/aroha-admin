                        ...
                        <div class="flex justify-between gap-2.5 border-b border-slate-300 p-4 dark:border-gray-800">
                            ...
                            <div class="flex gap-2.5">
                                ...
                                <div
                                    ...
                                    :class="{'overflow-hidden rounded-lg border border-dashed border-gray-300 dark:border-gray-800 dark:mix-blend-exclusion dark:invert': ! element.associated_product.images.length}"
                                >
