                ...
                <div class="flex flex-col gap-2 {{ $column == 1 ? 'flex-1 max-xl:flex-auto' : 'w-[360px] max-w-full max-sm:w-full' }}">
                    @foreach ($groups as $group)
                        ...
                        @if (count($customAttributes))
                            ...
                            <div class="box-shadow relative rounded-lg bg-white p-4 dark:bg-gray-900">
                                    ...
                                    <x-admin::form.control-group class="last:!mb-0">
                                        <x-admin::form.control-group.label>
                                            ...
                                            @if (
                                                ...
                                                <span class="rounded-lg border border-gray-200 bg-gray-100 px-1 py-0.5 text-[10px] font-semibold leading-normal text-gray-600">
                                                    {{ $currentChannel->name }}
                                                </span>
                                            @endif
