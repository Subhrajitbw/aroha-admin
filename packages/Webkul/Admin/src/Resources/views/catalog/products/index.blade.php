                ...
                >
                    ...
                    <div class="flex gap-1.5">
                        <div class="relative">
                            ...
                            <template v-else>
                                <div class="relative h-[60px] max-h-[60px] w-full max-w-[60px] rounded-lg border border-dashed border-gray-300 dark:border-gray-800 dark:mix-blend-exclusion dark:invert">
