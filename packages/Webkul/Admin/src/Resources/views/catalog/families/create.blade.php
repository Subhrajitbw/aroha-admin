<x-admin::layouts>
    ...
    <x-admin::form :action="route('admin.catalog.families.store')">
        ...
        <div class="mt-3.5 flex gap-2.5 max-xl:flex-wrap">
            <!-- Left Container -->
            <div class="box-shadow flex flex-1 flex-col gap-2 rounded-lg bg-white dark:bg-gray-900 max-xl:flex-auto">
                <v-family-attributes>
                            ...
                            <template #item="{ element, index }">
                                <div class="">
                                    ...
                                    <div class="group flex items-center">
                                        ...
                                        <!-- Group Name -->
                                        <div
                                            class="group_node group flex max-w-max cursor-pointer gap-1.5 rounded-lg py-1.5 text-gray-600 transition-all group-hover:text-gray-800 dark:text-gray-300 dark:group-hover:text-white ltr:pr-1.5 rtl:pl-1.5"
                                    ...
                                    >
                                        <template #item="{ element, index }">
                                            <div class="group flex max-w-max gap-1.5 rounded-lg py-1.5 text-gray-600 dark:text-gray-300 ltr:pr-1.5 rtl:pl-1.5">
