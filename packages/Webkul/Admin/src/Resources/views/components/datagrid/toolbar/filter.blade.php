                ...
                >
                    <x-slot:toggle>
                        <div>
                            ...
                            <div class="z-10 hidden w-full divide-y divide-gray-100 rounded-lg bg-white shadow dark:bg-gray-900">
                            </div>
                        </div>
                    </x-slot>
                                    ...
                                    <div class="grid !p-0">
                                        ...
                                        <div v-for="(filter,index) in savedFilters.available">
                                            ...
                                            >
                                                ...
                                                <span
                                                    class="icon-cross rounded-lg p-1.5 text-lg hover:bg-gray-200 dark:hover:bg-gray-800"
                                                ...
                                                <template v-if="column.filterable_type === 'dropdown'">
                                                    ...
                                                    <div class="mb-4 flex flex-wrap gap-2">
                                                        ...
                                                        <template v-if="column.allow_multiple_values">
                                                            <p
                                                                class="flex items-center rounded-lg bg-gray-600 px-2 py-1 font-semibold text-white"
                                                        ...
                                                        >
                                                            ...
                                                            <div class="mb-4 flex flex-wrap gap-2">
                                                                ...
                                                                <template v-if="column.type === 'date' || column.type === 'datetime'">
                                                                    <p class="flex items-center rounded-lg bg-gray-600 px-2 py-1 font-semibold text-white">
                                                                        <span>
